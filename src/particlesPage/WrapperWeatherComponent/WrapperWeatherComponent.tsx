...
const WrapperWeatherComponent: React.FC = () => {
  ...
  return (
      <section className={`w-full mx-auto px-4 flex flex-col gap-8 md:px-16 md:px-8`}>
        <input
            className={`w-full mx-auto bg-primary_40 p-4 text-base rounded-lg md:w-xl md:text-xl`}
